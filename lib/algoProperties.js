...
var algos = module.exports = global.algos = {
    ...
    'yespowerSUGAR': {
        ...
        hash: function(coinConfig){
            ...
            return function(data){
                return multiHashing.sugarchain(data,nValue,rValue);
            }
        }
    },
    'yespowerURX': {
    ...
    'yespowerLITB': {
        multiplier: Math.pow(2, 16),
        diff: parseInt('0x001fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff'),
        hash: function(coinConfig){
            var nValue = coinConfig.nValue || 2048;
            var rValue = coinConfig.rValue || 32;
            return function(data){
    ...
    'yespowerIOTS': {
        ...
        hash: function(coinConfig){
            var nValue = coinConfig.nValue || 1024;
            var rValue = coinConfig.rValue || 16;
            return function(data){
                return multiHashing.yespower_IOTS(data,nValue,rValue);
            }
        }
    },
    'cpupower': {
    ...
    'ltncg': {
        ...
        hash: function(coinConfig){
            ...
            var rValue = coinConfig.rValue || 32;
            return function(data){
                return multiHashing.ltncg(data,nValue,rValue);
            }
        }
    },
    c11: {
